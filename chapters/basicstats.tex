...
Most fractions can be stated as decimals\index[terms]{Probabilities!Decimal}, or at least approximated to a useful level of precision (that is to the point where any further precision would be masked by maximum precision that other figures can be measured to) such as
\begin{equation}
